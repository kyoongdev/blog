...
export const projects: Array<TProject> = [
  ...
  },
  {
    ...
    description:
      '<p>서비스 전반적인 백엔드 개발 및 DB설계를 총괄하였습니다.</p><p>서비스 규모가 크고, 대규모 데이터를 이관하는 과정이 있어 서비스 설계 시, 도메인 단위 설계 및 Transaction을 통한 쿼리 관리를 진행했습니다.</p>',
  ...
  },
  {
    ...
    description:
      '<p>마켓컬리와 유사한 식품 전자상거래 서비스입니다.</p><p>전자상거래 서비스 특징 상 보안 및 DB 원자성이 필수이기 때문에 토큰 및 bcrypt를 통한 데이터 통신 및 보관의 보안을 힘쓰고 transaction을 통해 쿼리 결과를 보존하였습니다.</p>',
